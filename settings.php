...
<div class="main_column column">
    ...
    <form action="settings.php" method="POST">
        ...
        <input type="submit" name="update_password" id="save_details" value="Update password" id="settings_input" class="info settings_submit"><br>
    </form>

    <h4>Delete Account </h4>
    <form action="settings.php" method="POST">
        <input type="submit" name="close_account" value="Delete Account" class="danger settings_submit"><br>
    </form>
