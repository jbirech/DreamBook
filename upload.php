...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/Dreambook/Dreambook-blue/assets/images/profile_pics';
	//Set File name	
...
***********************************************************/		
		...
		//create new image using correct php func			
			...
			}elseif($_FILES["image"]["type"] == "image/png" || $_FILES["image"]["type"] == "video/mp4"){ 
...
if (isset($_POST['x'])){
	...
	if($type == 'jpg' || $type == 'jpeg' || $type == 'JPG' || $type == 'JPEG' || $type == 'mp4'){	
