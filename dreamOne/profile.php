...
if(isset($_GET['profile_username']))
{
	...
	$num_friends = (substr_count($user_array['friend_arrary'], ",")) - 1; // -1 if for the database when the user has no friend we dont want it to count the comma as a friend
...
?>
	...
	<div class="profile_left">
		...
		<form action="<?php echo $username; ?>" method="POST">
			...
			{
				//checks if the user logged in are friends, send request, delete request and unfriend
...
<!-- Modal -->
<div class="modal fade" id="post_form" tabindex="-1" role="dialog" aria-labelledby="poatModalLabel" aria-hidden="true">
